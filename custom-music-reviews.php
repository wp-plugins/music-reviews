...
* Plugin URI: study4u.net/plugin/custom-music-reviews.zip
* Description: This is custom music review plugin where you can able to create the genres list and then assign the review for that genres or without genres. 
* Version: 1.0
* Author: Nilesh
**/
